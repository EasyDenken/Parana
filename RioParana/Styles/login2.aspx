                                        ...
                                        <h3>Administración</h3>
                                            ...
                                            <fieldset>
                                               ...
                                               <!--     <asp:Button ID="btnAcceder" runat="server" Text="INGRESAR" onclick="btnAcceder_Click" class="btn" BackColor="#FE0045" BorderColor="#CCFFFF" CssClass="btn" ForeColor="White" Font-Bold="True" /> -->
                                                      <a class="btn" onclick="btnAcceder_Click" runat="server">INGRESAR</a>
                                               
                                               
                                                </div>
                                                <a href="#">Pedir contrase&ntilde;a</a>
                                                <div class="mensaje_estado_ingreso">
                                                    <asp:Label ID="lblMensaje" runat="server" Text="" ForeColor="Red" Font-Bold="True" CssClass="btn"></asp:Label>
                                                </div>
                                            </fieldset>                   
