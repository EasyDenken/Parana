...
namespace GoogleGeocoder
{
    ...
    public class Geocode
    {
        ...
        private const string _googleUri2 = "http://maps.googleapis.com/maps/api/geocode/xml?sensor=false&address=";
        private const string _googleKey = "AIzaSyCGMHKRb4ZU6L0SBeW1j2bAts5oc-a23uI"; // Get your key from:  http://www.google.com/apis/maps/signup.html
        //private const string _googleKey = "ABQIAAAApU_iFCnQtFqCJz_RVHKf6hSYLG6fDlhVEk874HydvxxZhp9wgBSK31r-0Anfgbtaadn7tjgFYe9D9w"; // Get your key from:  http://www.google.com/apis/maps/signup.html
        ...
        private static string GetGeocodeUri2(string address)
        {
            //address = HttpUtility.UrlEncode(address);
            return String.Format("{0}{1}", _googleUri2, address);

            //return new Uri(string.Format("http://maps.googleapis.com/maps/api/geocode/json?sensor=false&address=San+Lorenzo+2729,Rosario&"));
        }
        ...
        public static Coordinate GetCoordinates2(string address)
        {
        ...
        public static Coordinate GetCoordinates(string address)
        {
            ...
            xDoc.Load(GetGeocodeUri2(address));
            ...
            return new Coordinate(Convert.ToDecimal(lat), Convert.ToDecimal(longitude));
        }
