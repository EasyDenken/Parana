<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeBehind="FichaPropiedad.aspx.cs" Inherits="RioParana.Admin.FichaPropiedad" %>
...
<script language="JavaScript" type="text/javascript">
    ...
    <div>
        <input type="button" value="Imprimir Ficha" 
            ...
            style="position:relative; z-index: 3; top: 0px; left: -250px; " />
    </div>
                    ...
                    <asp:updatepanel runat="server" ID="upDetail">
                        <ContentTemplate>
                            <asp:DetailsView ID="DetailsView1" runat="server" CellPadding="1" ForeColor="#333333"
                                ...
                                CaptionAlign="Right" Style="margin-left: 0px" Width="567px" 
            ...
            <tr>
                <td colspan="2" style="height: 114px" align="center">
                    <asp:panel ID="Panel1" runat="server">
                        <cc2:GoogleMap BorderStyle="Solid" BorderWidth="2" EnableDoubleClickZoom="true" EnableScrollWheelZoom="true"
