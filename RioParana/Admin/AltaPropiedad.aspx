<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true"
    CodeBehind="AltaPropiedad.aspx.cs" Inherits="RioParana.Admin.AltaPropiedad" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div align="center">
        <script type="text/javascript">
            AC_FL_RunContent('codebase', 'http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0', 'width', '710', 'height', '50', 'src', 'secciones?textoweb= -  Alta Propiedad - ', 'quality', 'high', 'pluginspage', 'http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash', 'wmode', 'transparent', 'movie', 'secciones?textoweb= -  Alta Propiedad - '); //end AC code
        </script>
        <noscript>
            <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0"
                width="710" height="50">
                <param name="movie" value="secciones.swf?textoweb= -  Alta Propiedad - " />
                <param name="quality" value="high" />
                <param name="wmode" value="transparent" />
                <embed src="secciones.swf?textoweb= -  Alta Propiedad - " width="710" height="50"
                    ...
                    <tr>
                        ...
                        <td style="height: 7px">
                            <asp:RadioButtonList ID="rblVisible" runat="server" RepeatDirection="Horizontal"
                                Font-Underline="False" CellPadding="0" CellSpacing="0">
                        ...
                        <tr>
                            ...
                            <td width="0" style="width: 0px;">
                                <asp:UpdateProgress ID="UpdateProgress3" runat="server" AssociatedUpdatePanelID="UpdatePanel8">
                                    <ProgressTemplate>
                                        <img height="16" src="../Css/ajax-loader.gif" width="16" alt=""> </img>
                                    </ProgressTemplate>
                                </asp:UpdateProgress>
                            </td>
                            <td width="393" style="text-align: left">
                                <asp:UpdatePanel ID="UpdatePanel8" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <asp:DropDownList ID="ddlProvincias" runat="server" AutoPostBack="True" DataSourceID="odsProvincias"
                                            DataTextField="Nombre" DataValueField="idProvincia" Width="220px">
                                        </asp:DropDownList>
                                ...
                                <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <asp:DropDownList ID="ddlLocalidades" runat="server" AutoPostBack="True" DataSourceID="odsLocalidades"
                                            DataTextField="Nombre" DataValueField="idLocalidad" Width="220px">
                                        </asp:DropDownList>
                            ...
                            <td width="393" style="height: 5px; text-align: left;">
                                <asp:UpdatePanel ID="UpdatePanel11" runat="server">
                                    <ContentTemplate>
                                        ...
                                        &nbsp;<a href="javascript:pantallacompleta('../images/defaultcss/full.html')"> Ver</a>
                                        &nbsp;
            ...
            <div class="entry">
                <table align="center" style="height: 66px">
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <asp:TextBox ID="txtMetrosCuadradosSemi" runat="server" MaxLength="10" onKeypress="return isNumberKeyComa(event)"
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <asp:UpdatePanel ID="UpdatePanel12" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <asp:TextBox ID="txtFrente" onkeypress="return isNumberKeyComa(event)" runat="server"
                                        Width="222px" Enabled="False" MaxLength="49"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="rfvFrente" runat="server" ControlToValidate="txtMetrosCuadrados"
                                        ErrorMessage="Ingrese un valor" SetFocusOnError="True"></asp:RequiredFieldValidator>
                                </ContentTemplate>
                                <Triggers>
                                    <asp:AsyncPostBackTrigger ControlID="ddlTipoDeInmueble" EventName="SelectedIndexChanged" />
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <asp:UpdatePanel ID="UpdatePanel13" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <asp:TextBox ID="txtFondo" onkeypress="return isNumberKeyComa(event)" runat="server"
                                        Width="222px" Enabled="False" MaxLength="49"></asp:TextBox>
                                </ContentTemplate>
                                <Triggers>
                                    <asp:AsyncPostBackTrigger ControlID="ddlTipoDeInmueble" EventName="SelectedIndexChanged" />
